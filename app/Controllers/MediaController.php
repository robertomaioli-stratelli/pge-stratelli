...
final class MediaController
{
    ...
    {
        $mid=(int)$id;$pdo=Database::connection();$st=$pdo->prepare('SELECT id,geojson_delimitacao,inteligencia_territorial_ativa FROM municipios WHERE id=? AND ativo=1 LIMIT 1');$st->execute([$mid]);$m=$st->fetch();
