...
<div class="login-shell">
    <section class="login-brand-panel"><div class="login-mark">IN</div><h1>INPACTA by Stratelli</h1><p>PGE - Plataforma de Governança Executiva</p><div class="login-security">Ambiente autenticado e segregado por município.</div></section>
